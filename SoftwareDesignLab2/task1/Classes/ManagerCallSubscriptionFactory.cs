...
public class ManagerCallSubscriptionFactory : SubscriptionFactory
{
    ...
    {
        Console.WriteLine("Creating a domestic subscription via a manager call...");
    ...
    {
        Console.WriteLine("Creating a premium subscription via a manager call...");
    ...
    override public ISubscription CreateEducationalSubscription()
    {
        ...
        Console.WriteLine("Creating an educational subscription via a manager call...");
