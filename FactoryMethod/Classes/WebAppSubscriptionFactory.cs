...
public class WebSiteSubscriptionFactory : SubscriptionFactory
{
    ...
    {
        Console.WriteLine("Creating a domestic subscription via a web site...");
    ...
    {
        Console.WriteLine("Creating a premium subscription via a web site...");
    ...
    override public ISubscription CreateEducationalSubscription()
    {
        ...
        Console.WriteLine("Creating an educational subscription via a web site...");
